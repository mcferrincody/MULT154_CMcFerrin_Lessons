...
public class Bot : MonoBehaviour
{
    ...
    public bool CanSeeTarget()
    {
        ...
        Vector3 targetXYZPos = new Vector3(target.transform.position.x, 1.5f, target.transform.position.z);
        Vector3 thisXYZPos = new Vector3(transform.position.x, 1.5f, transform.position.z);
        Vector3 rayToTarget = targetXYZPos - thisXYZPos;
        if (Physics.Raycast(thisXYZPos, rayToTarget, out raycastInfo))
        {
